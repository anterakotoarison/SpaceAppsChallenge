...
def open_new_window():
    ...
    location_label = tk.Label(root, text="Insert your location")
    location_label.pack()
    ...
    date_label = tk.Label(root, text="Insert your data")
    date_label.pack()
    ...
    next_button = tk.Button(root, text="NEXT", command=open_explore_page)
    next_button.pack()
    next_button.place(relx=0.5, rely=0.65, anchor="center")

    back_button = tk.Button(root, text="BACK", command=open_main_window)
    back_button.pack()
